...
__syscall_prefix __syscall_##name(void) { \
    long ret; \
...
__syscall_prefix __syscall_##name(t1 p1, t2 p2) { \
    ...
    asm volatile (SYSCALL_INSTRUCTION \
        : "=a"(ret) \
        : "a"((long)(num)), "D"((long)p1), "S"((long)p2) \
        : SYSCALL_CLOBBERS); \
    return ret; \
}
...
__syscall_prefix __syscall_##name(t1 p1, t2 p2, t3 p3) { \
    ...
    asm volatile (SYSCALL_INSTRUCTION \
        : "=a"(ret) \
        : "a"((long)(num)), "D"((long)p1), "S"((long)p2), "d"((long)p3) \
        : SYSCALL_CLOBBERS); \
    return ret; \
}
...
__syscall_prefix __syscall_##name(t1 p1, t2 p2, t3 p3, t4 p4) { \
    long ret; \
    register long r10 __asm__("r10") = (long)p4; \
    asm volatile (SYSCALL_INSTRUCTION \
        : "=a"(ret) \
        : "a"((long)(num)), "D"((long)p1), "S"((long)p2), "d"((long)p3), "r"(r10) \
        : SYSCALL_CLOBBERS); \
    return ret; \
}
...
__syscall_prefix __syscall_##name(t1 p1, t2 p2, t3 p3, t4 p4, t5 p5) { \
    long ret; \
    register long r10 __asm__("r10") = (long)p4; \
    register long r8  __asm__("r8")  = (long)p5; \
    asm volatile (SYSCALL_INSTRUCTION \
        : "=a"(ret) \
        : "a"((long)(num)), "D"((long)p1), "S"((long)p2), "d"((long)p3), \
          "r"(r10), "r"(r8) \
...
__syscall_prefix __syscall_##name(t1 p1, t2 p2, t3 p3, t4 p4, t5 p5, t6 p6) { \
    ...
    register long r10 __asm__("r10") = (long)p4; \
    register long r8  __asm__("r8")  = (long)p5; \
    register long r9  __asm__("r9")  = (long)p6; \
    asm volatile (SYSCALL_INSTRUCTION \
        : "=a"(ret) \
        : "a"((long)(num)), "D"((long)p1), "S"((long)p2), "d"((long)p3), \
          "r"(r10), "r"(r8), "r"(r9) \
...
#define SYSCALL6(num, p1, p2, p3, p4, p5, p6) \
({ \
    long ret; \
    register long r10 __asm__("r10") = (long)(p4); \
    register long r8  __asm__("r8")  = (long)(p5); \
